import mainMobileLine from "../img/main-mobile-line.svg";
        ...
        <div className="main__wrapper">
          ...
          <div className="main__advice">
            ...
            <div className="main__layout-mobile">
              <div>
                <img src={mainMobileLine} alt="" className="main__line" />
            ...
            <img className="main__red-ball" src={redBall} alt="red ball" />
          </div>
        </div>
      </div>
    </main>
